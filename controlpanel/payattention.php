    ...
    class dbo_payattentionPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->addFields(
                array(
                    ...
                    new StringField('whatmonth', true),
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'whatmonth', 'whatmonth', 'Whatmonth'),
                ...
                new FilterColumn($this->dataset, 'latest', 'latest', 'Latest')
            );
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('whatmonth_edit');
            ...
            $main_editor = new ComboBox('latest');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            // View column for whatmonth field
            //
            $column = new TextViewColumn('whatmonth', 'whatmonth', 'Whatmonth', $this->dataset);
            ...
            //
            // View column for latest field
            //
            $column = new CheckboxViewColumn('latest', 'latest', 'Latest', $this->dataset);
            $column->SetOrderable(true);
        ...
        {
            //
            // Edit column for whatmonth field
            //
            $editor = new TextEdit('whatmonth_edit');
            $editColumn = new CustomEditColumn('Whatmonth', 'whatmonth', $editor, $this->dataset);
            ...
            //
            // Edit column for latest field
            //
            $editor = new CheckBox('latest_edit');
            $editColumn = new CustomEditColumn('Latest', 'latest', $editor, $this->dataset);
